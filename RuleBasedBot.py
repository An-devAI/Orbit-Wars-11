...
def update_params(step, initial_by_id, planets):
    ...
    if globals().get("TUNE_MODE", False):
        ...
        return
    if is_1v1:
        if is_early:  ALPHA, BETA, GAMMA, DELTA, EPSILON, MAX_ARRIVAL_TURNS = 1.83, 1.82, 1.36, 4.08, 0.70, 26
        else: ALPHA, BETA, GAMMA, DELTA, EPSILON, MAX_ARRIVAL_TURNS = 2.48, 5.00, 1.39, 2.04, 2.02, 34
    else:
        if is_early:
