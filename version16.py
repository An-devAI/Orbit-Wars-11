            ...
            if mtype == "CAPTURE":
                ...
                if enemy_arr:
                    ...
                    if should_steal and wait_needed <= 15:
                        ...
                        # Anti-vulture filter: If enemy can vulture us shortly after arrival
                        # and we can't afford to send enough to hold it for 10 turns.
                        ...
                        if cost_to_hold > budget_now:
                            # Check for actual enemy threats arriving in the immediate future
