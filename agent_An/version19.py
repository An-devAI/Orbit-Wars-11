...
def update_params(step, initial_by_id, planets):
    ...
    if globals().get("TUNE_MODE", False):
        ...
        return
    if is_1v1:
        if is_early: ALPHA, BETA, GAMMA, DELTA, EPSILON, MAX_ARRIVAL_TURNS = 1.86, 0.71, 1.82, 2.34, 2.38, 21
        else: ALPHA, BETA, GAMMA, DELTA, EPSILON, MAX_ARRIVAL_TURNS = 3.52, 0.42, 1.36, 3.05, 2.27, 28
    else:
